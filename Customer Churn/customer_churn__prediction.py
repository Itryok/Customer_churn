...
Original file is located at
    https://colab.research.google.com/drive/121DLbvZhPcqCHh-qit5SS0iJgtE2uieZ

<a id = "8" ></a>
# <span style="font-family:serif; font-size:28px;">Loading Dataset</span>
<a id = "8" ></a>
"""
...
"""There are some missing spaces in the data"""
...
Checking if there are any other 0 values in the tenure column.
"""
...
"""> To solve the problem of missing values in TotalCharges column,imputation was done"""
...
"""Since the numerical features are distributed over different value ranges,standard scalar is used to scale them down to the same range.(Normalization)
...
"""<a id = "11" ></a>
# <span style="font-family:serif; font-size:28px;">K Means Clustering</span>
...
for cluster in df['cluster'].unique():
    ...
    ax.scatter(cluster_data['tenure'], cluster_data['MonthlyCharges'], cluster_data['TotalCharges'], color=colors[cluster],label= f'Cluster {cluster}')
...
for cluster in df['cluster'].unique():
    cluster_data = df[df['cluster'] == cluster]
    ax.scatter(cluster_data['MonthlyCharges'], cluster_data['tenure'],cluster_data['TotalCharges'], color=colors[cluster],label= f'Cluster {cluster}')
